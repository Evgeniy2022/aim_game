...
const colors = ['#0000CC', '#00FF33', '#9900FF', '#CC3333', '#FFFF33']
...
board.addEventListener('hovered', () => setColor(circle))
...
function createRandomCircle() {
	...
	circle.style.background = colors[getRandomNamber(0, colors.length)];
	board.append(circle)
}
